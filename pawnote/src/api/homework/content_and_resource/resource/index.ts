...
export class Homework_89_Resource_API extends RequestFunction<HomeworkRequest, HomeworkRequestSignature> {
	...
	constructor(
		...
		super(user.session, Homework_89_Resource_API.name);
		this.user = user;
